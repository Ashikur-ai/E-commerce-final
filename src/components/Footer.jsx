      ...
      <footer className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-12 gap-20 lg:gap-5 container mx-auto text-base-content px-10 py-14">
        ...
        <nav className="col-span-2 lg:col-span-4 gap-20 lg:gap-0 flex lg:justify-around md:justify-evenly">
          <div  className="space-y-2">
            ...
            <Link to={`/Features`} className="link link-hover block">Features</Link>
            <Link to={`/Works`} className="link link-hover block">Works</Link>
            <Link to={`/Career`} className="link link-hover block">Career</Link>
          </div>
          <div  className="space-y-2">
            <h6 className="footer-title">Help</h6>
            <Link to={`/Customer`} className="link link-hover block">Customer Support</Link>
            <Link to={`/Delivery`} className="link link-hover block">Delivery Details</Link>
            <Link to={`/Terms`} className="link link-hover block">Terms & Conditions</Link>
        ...
        <nav className="col-span-2 lg:col-span-4 flex gap-20 lg:gap-0 lg:justify-around md:justify-evenly">
          <div className="space-y-2">
            ...
            <Link to={`/Account`} className="link link-hover block">Account</Link>
            <Link to={`/Manage`} className="link link-hover block">Manage Deliveries</Link>
            <Link to={`/Orders`} className="link link-hover block">Orders</Link>
            <Link to={`/Payments`} className="link link-hover block">Payments</Link>
          </div>
          <div  className="space-y-2">
            <h6 className="footer-title">Resources</h6>
            <Link to={`/Free`} className="link link-hover block">Free eBooks</Link>
            <Link to={`/Development`} className="link link-hover block">Development Tutorial</Link>
            <Link to={`/How`} className="link link-hover block">How to - Blog</Link>
            <Link to={`/Youtube`} className="link link-hover block">Youtube Playlist</Link>
          </div>
        </nav>
      ...
      <footer className="flex flex-col lg:flex-row gap-5 items-center justify-between container mx-auto bg-base-200 text-base-content border-base-300 border-t px-10 py-4">
        ...
        <nav className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-2 ">
            <div>
                 <img src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508246/Badge_4_xtg1jo.png" alt="" />
            </div>
            <div>
                 <img src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508311/Badge_epq0c4.png" alt="" />
            </div>
            <div>
                 <img src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508335/Badge_1_he4sfd.png" alt="" />
            </div>
            <div>
                 <img src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508363/Badge_2_xgkizb.png" alt="" />
            </div>
            <div>
                 <img src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508381/Badge_3_kv0fgp.png" alt="" />
            </div>
          </div>
        </nav>
      </footer>
